...
function MapAndMissionPage() {
  ...
  const [mapInfo, setMapInfo] = useState({ headline: "", additionalData: "" });
  ...
  const setMapInfoHandler = (header, moreData) => {
    const newObj = { headline: header, additionalData: moreData };
    setMapInfo(newObj);
  };

  useEffect(() => {
    console.log('got here')
    if (mapInfo.headline || mapInfo.additionalData) {
                  ...
                  >
                    ...
                    <CardActions>
                      <Button
                        ...
                        onClick={() =>
                          setMapInfoHandler(mapa.headline, mapa.additionalData)
                        }
                      >
                        Learn More
                      </Button>
